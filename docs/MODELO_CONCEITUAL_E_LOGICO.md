...
*(As etapas seguintes — **Etapa 2: Implementação do Backend (APIs CRUD e 5 Filtros com Joins)**, **Etapa 3: Testes e Documentação (Swagger UI e Relatório)** e **Etapa 4: Vídeo Apresentação (Pitch)** — serão desenvolvidas em seus respectivos momentos).*
